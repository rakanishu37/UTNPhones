...
public class ClientController {
    ...
    private void validateLogin(String token) throws UserNotLoggedException, UnauthorizedAccessException {
        validateEmployee(sessionManager.getSession(token).getLoggedUser());
    }

    private void validateEmployee(Person person) throws UnauthorizedAccessException {
        if(!person.getUserType().equals(USER_TYPE_EMPLOYEE)){
